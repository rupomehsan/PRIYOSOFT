...
namespace Modules\Management\WebsiteManagement\WhoWeAre\Actions;
...
class GetAllData
{
    ...
    $q->orWhere('badge_label', 'like', '%' . $searchKey . '%');    
    ...
    $q->orWhere('stat_value', 'like', '%' . $searchKey . '%');    

    $q->orWhere('stat_label', 'like', '%' . $searchKey . '%');    

    $q->orWhere('sort_order', 'like', '%' . $searchKey . '%');    

    $q->orWhere('is_visible', 'like', '%' . $searchKey . '%');              
