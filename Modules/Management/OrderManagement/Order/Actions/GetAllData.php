...
class GetAllData
{
    ...
    $q->orWhere('plan_name', 'like', '%' . $searchKey . '%');    

    $q->orWhere('billing_cycle', 'like', '%' . $searchKey . '%');    

    $q->orWhere('status', 'like', '%' . $searchKey . '%');    

    $q->orWhere('delivery_method', 'like', '%' . $searchKey . '%');    
    ...
    $q->orWhere('coupon_code', 'like', '%' . $searchKey . '%');    

    $q->orWhere('customer_note', 'like', '%' . $searchKey . '%');    

    $q->orWhere('ordered_at', 'like', '%' . $searchKey . '%');    

    $q->orWhere('payment_verified_at', 'like', '%' . $searchKey . '%');    

    $q->orWhere('access_sent_at', 'like', '%' . $searchKey . '%');    

    $q->orWhere('cancelled_at', 'like', '%' . $searchKey . '%');    
