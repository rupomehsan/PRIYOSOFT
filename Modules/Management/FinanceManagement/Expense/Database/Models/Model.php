...
namespace Modules\Management\FinanceManagement\Expense\Database\Models;
...
class Model extends EloquentModel
{
    ...
    public function expenseCategoryId()
    {
        return $this->belongsTo(\Modules\Management\FinanceManagement\ExpenseCategory\Database\Models\Model::class, 'expense_category_id');
    }
    public function productId()
    {
        return $this->belongsTo(\Modules\Management\ProductManagement\Product\Database\Models\Model::class, 'product_id');
    }
