/**
 * BlogPost Module Setup Configuration
 *
 * This file contains all configuration for the BlogPost module including:
...
const prefix: string = "BlogPost";

const setup: setup_type = {
    // Module Identity
    prefix,
    module_name: "blog-post",
    store_prefix: "blog-post",
    route_prefix: "BlogPost",
    ...
    permission_slugs: {
        ...
        import: "blog-post-import",
    },

    // API Configuration
    api_host: app_config.api_host,
    api_version: app_config.api_version,
    api_end_point: "blog-posts",
