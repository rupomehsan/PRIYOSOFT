/**
 * BlogPost Store - Factory Pattern Implementation
 *
...
// Create the BlogPost store with all CRUD functionality
export const blog_post_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = blog_post_store;

// Default export for Composition API usage
export default blog_post_store;
