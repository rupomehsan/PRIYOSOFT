/**
 * SiteSection Store - Factory Pattern Implementation
 *
...
// Create the SiteSection store with all CRUD functionality
export const site_section_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = site_section_store;

// Default export for Composition API usage
export default site_section_store;
