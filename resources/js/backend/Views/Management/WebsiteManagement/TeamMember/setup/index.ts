/**
 * TeamMember Module Setup Configuration
 *
 * This file contains all configuration for the TeamMember module including:
...
const prefix: string = "TeamMember";

const setup: setup_type = {
    // Module Identity
    prefix,
    module_name: "team-member",
    store_prefix: "team-member",
    route_prefix: "TeamMember",
    route_path: "team-member",
    ...
    permission_slugs: {
        ...
        import: "team-member-import",
    },

    // API Configuration
    api_host: app_config.api_host,
    api_version: app_config.api_version,
    api_end_point: "team-members",
