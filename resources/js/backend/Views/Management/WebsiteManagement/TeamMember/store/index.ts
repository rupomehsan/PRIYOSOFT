/**
 * TeamMember Store - Factory Pattern Implementation
 *
...
// Create the TeamMember store with all CRUD functionality
export const team_member_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = team_member_store;

// Default export for Composition API usage
export default team_member_store;
