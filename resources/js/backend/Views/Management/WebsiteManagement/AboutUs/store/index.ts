/**
 * AboutUs Store - Factory Pattern Implementation
 *
...
// Create the AboutUs store with all CRUD functionality
export const about_us_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = about_us_store;

// Default export for Composition API usage
export default about_us_store;
