/**
 * ContactLead Store - Factory Pattern Implementation
 *
...
// Create the ContactLead store with all CRUD functionality
export const contact_lead_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = contact_lead_store;

// Default export for Composition API usage
export default contact_lead_store;
