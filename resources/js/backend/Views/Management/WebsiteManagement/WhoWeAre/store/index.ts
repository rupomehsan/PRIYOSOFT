/**
 * WhoWeAre Store - Factory Pattern Implementation
 *
...
// Create the WhoWeAre store with all CRUD functionality
export const who_we_are_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = who_we_are_store;

// Default export for Composition API usage
export default who_we_are_store;
