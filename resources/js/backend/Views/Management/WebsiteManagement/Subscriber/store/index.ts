/**
 * Subscriber Store - Factory Pattern Implementation
 *
...
// Create the Subscriber store with all CRUD functionality
export const subscriber_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = subscriber_store;

// Default export for Composition API usage
export default subscriber_store;
