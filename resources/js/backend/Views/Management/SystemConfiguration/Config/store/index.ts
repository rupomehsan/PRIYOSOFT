/**
 * Config Store - Factory Pattern Implementation
 *
...
// Create the Config store with all CRUD functionality
export const config_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = config_store;
