/**
 * Conversation Store - Factory Pattern Implementation
 *
...
// Create the Conversation store with all CRUD functionality
export const conversation_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = conversation_store;

// Default export for Composition API usage
export default conversation_store;
