/**
 * Message Store - Factory Pattern Implementation
 *
...
// Create the Message store with all CRUD functionality
export const message_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = message_store;
