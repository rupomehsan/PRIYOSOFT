/**
 * MessageReadStatus Store - Factory Pattern Implementation
 *
 ...
 * @package MessageReadStatus
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the MessageReadStatus store with all CRUD functionality
export const message_read_status_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = message_read_status_store;

// Default export for Composition API usage
export default message_read_status_store;
