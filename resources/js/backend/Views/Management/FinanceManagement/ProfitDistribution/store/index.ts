/**
 * ProfitDistribution Store - Factory Pattern Implementation
 *
 ...
 * @package ProfitDistribution
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ProfitDistribution store with all CRUD functionality
export const profit_distribution_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = profit_distribution_store;

// Default export for Composition API usage
export default profit_distribution_store;
