/**
 * Investment Store - Factory Pattern Implementation
 *
...
// Create the Investment store with all CRUD functionality
export const investment_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = investment_store;

// Default export for Composition API usage
export default investment_store;
