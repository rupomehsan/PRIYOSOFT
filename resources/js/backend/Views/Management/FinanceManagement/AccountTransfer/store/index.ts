/**
 * AccountTransfer Store - Factory Pattern Implementation
 *
...
// Create the AccountTransfer store with all CRUD functionality
export const account_transfer_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = account_transfer_store;

// Default export for Composition API usage
export default account_transfer_store;
