/**
 * Investor Store - Factory Pattern Implementation
 *
...
// Create the Investor store with all CRUD functionality
export const investor_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = investor_store;

// Default export for Composition API usage
export default investor_store;
