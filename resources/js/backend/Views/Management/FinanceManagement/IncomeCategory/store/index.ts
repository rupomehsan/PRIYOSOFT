/**
 * IncomeCategory Store - Factory Pattern Implementation
 *
...
// Create the IncomeCategory store with all CRUD functionality
export const income_category_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = income_category_store;

// Default export for Composition API usage
export default income_category_store;
