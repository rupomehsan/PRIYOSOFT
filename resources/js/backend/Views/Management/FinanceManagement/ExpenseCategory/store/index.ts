/**
 * ExpenseCategory Store - Factory Pattern Implementation
 *
...
// Create the ExpenseCategory store with all CRUD functionality
export const expense_category_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = expense_category_store;

// Default export for Composition API usage
export default expense_category_store;
