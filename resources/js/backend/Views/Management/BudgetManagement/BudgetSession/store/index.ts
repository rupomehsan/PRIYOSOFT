/**
 * BudgetSession Store - Factory Pattern Implementation
 *
 ...
 * @package BudgetSession
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the BudgetSession store with all CRUD functionality
export const budget_session_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = budget_session_store;

// Default export for Composition API usage
export default budget_session_store;
