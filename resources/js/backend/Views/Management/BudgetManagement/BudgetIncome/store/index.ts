/**
 * BudgetIncome Store - Factory Pattern Implementation
 *
 ...
 * @package BudgetIncome
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the BudgetIncome store with all CRUD functionality
export const budget_income_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = budget_income_store;

// Default export for Composition API usage
export default budget_income_store;
