/**
 * BudgetExpense Store - Factory Pattern Implementation
 *
 ...
 * @package BudgetExpense
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the BudgetExpense store with all CRUD functionality
export const budget_expense_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = budget_expense_store;

// Default export for Composition API usage
export default budget_expense_store;
