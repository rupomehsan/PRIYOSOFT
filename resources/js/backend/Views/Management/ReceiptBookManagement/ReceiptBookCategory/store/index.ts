/**
 * ReceiptBookCategory Store - Factory Pattern Implementation
 *
 ...
 * @package ReceiptBookCategory
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ReceiptBookCategory store with all CRUD functionality
export const receipt_book_category_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = receipt_book_category_store;

// Default export for Composition API usage
export default receipt_book_category_store;
