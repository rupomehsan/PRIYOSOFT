/**
 * ReceiptBookAssign Store - Factory Pattern Implementation
 *
 ...
 * @package ReceiptBookAssign
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ReceiptBookAssign store with all CRUD functionality
export const receipt_book_assign_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = receipt_book_assign_store;

// Default export for Composition API usage
export default receipt_book_assign_store;
