/**
 * ReceiptBook Store - Factory Pattern Implementation
 *
...
// Create the ReceiptBook store with all CRUD functionality
export const receipt_book_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = receipt_book_store;

// Default export for Composition API usage
export default receipt_book_store;
