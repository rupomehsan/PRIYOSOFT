/**
 * ProductGroup Store - Factory Pattern Implementation
 *
...
// Create the ProductGroup store with all CRUD functionality
export const product_group_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = product_group_store;

// Default export for Composition API usage
export default product_group_store;
