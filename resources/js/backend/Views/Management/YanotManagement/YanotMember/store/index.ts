/**
 * YanotMember Store - Factory Pattern Implementation
 *
...
// Create the YanotMember store with all CRUD functionality
export const yanot_member_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = yanot_member_store;

// Default export for Composition API usage
export default yanot_member_store;
