/**
 * YanotRegister Store - Factory Pattern Implementation
 *
 ...
 * @package YanotRegister
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the YanotRegister store with all CRUD functionality
export const yanot_register_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = yanot_register_store;

// Default export for Composition API usage
export default yanot_register_store;
