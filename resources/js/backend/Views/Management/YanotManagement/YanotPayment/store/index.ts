/**
 * YanotPayment Store - Factory Pattern Implementation
 *
 ...
 * @package YanotPayment
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the YanotPayment store with all CRUD functionality
export const yanot_payment_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = yanot_payment_store;

// Default export for Composition API usage
export default yanot_payment_store;
