/**
 * LoanPayment Store - Factory Pattern Implementation
 *
...
// Create the LoanPayment store with all CRUD functionality
export const loan_payment_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = loan_payment_store;

// Default export for Composition API usage
export default loan_payment_store;
