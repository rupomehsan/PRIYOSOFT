/**
 * LoanGiven Store - Factory Pattern Implementation
 *
...
// Create the LoanGiven store with all CRUD functionality
export const loan_given_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = loan_given_store;

// Default export for Composition API usage
export default loan_given_store;
