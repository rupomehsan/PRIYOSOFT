/**
 * LoanTaken Store - Factory Pattern Implementation
 *
...
// Create the LoanTaken store with all CRUD functionality
export const loan_taken_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = loan_taken_store;

// Default export for Composition API usage
export default loan_taken_store;
