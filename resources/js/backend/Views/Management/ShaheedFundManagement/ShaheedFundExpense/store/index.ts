/**
 * ShaheedFundExpense Store - Factory Pattern Implementation
 *
 ...
 * @package ShaheedFundExpense
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ShaheedFundExpense store with all CRUD functionality
export const shaheed_fund_expense_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = shaheed_fund_expense_store;

// Default export for Composition API usage
export default shaheed_fund_expense_store;
