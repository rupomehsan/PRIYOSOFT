/**
 * ShaheedFundIncome Store - Factory Pattern Implementation
 *
 ...
 * @package ShaheedFundIncome
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ShaheedFundIncome store with all CRUD functionality
export const shaheed_fund_income_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = shaheed_fund_income_store;

// Default export for Composition API usage
export default shaheed_fund_income_store;
