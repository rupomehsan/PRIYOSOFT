/**
 * WelfareFundExpense Store - Factory Pattern Implementation
 *
 ...
 * @package WelfareFundExpense
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the WelfareFundExpense store with all CRUD functionality
export const welfare_fund_expense_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = welfare_fund_expense_store;

// Default export for Composition API usage
export default welfare_fund_expense_store;
