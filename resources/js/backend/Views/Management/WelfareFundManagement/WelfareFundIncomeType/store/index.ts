/**
 * WelfareFundIncomeType Store - Factory Pattern Implementation
 *
 ...
 * @package WelfareFundIncomeType
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the WelfareFundIncomeType store with all CRUD functionality
export const welfare_fund_income_type_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = welfare_fund_income_type_store;

// Default export for Composition API usage
export default welfare_fund_income_type_store;
