/**
 * WelfareFundIncome Store - Factory Pattern Implementation
 *
 ...
 * @package WelfareFundIncome
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the WelfareFundIncome store with all CRUD functionality
export const welfare_fund_income_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = welfare_fund_income_store;

// Default export for Composition API usage
export default welfare_fund_income_store;
