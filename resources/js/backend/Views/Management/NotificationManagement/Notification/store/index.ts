/**
 * Notification Store - Factory Pattern Implementation
 *
...
// Create the Notification store with all CRUD functionality
export const notification_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = notification_store;
