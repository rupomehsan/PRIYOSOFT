/**
 * NotificationRead Store - Factory Pattern Implementation
 *
...
// Create the NotificationRead store with all CRUD functionality
export const notification_read_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = notification_read_store;

// Default export for Composition API usage
export default notification_read_store;
