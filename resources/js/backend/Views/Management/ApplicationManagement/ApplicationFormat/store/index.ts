/**
 * ApplicationFormat Store - Factory Pattern Implementation
 *
 ...
 * @package ApplicationFormat
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ApplicationFormat store with all CRUD functionality
export const application_format_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = application_format_store;

// Default export for Composition API usage
export default application_format_store;
