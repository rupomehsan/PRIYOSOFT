/**
 * BranchTargetMoukufApplication Store - Factory Pattern Implementation
 *
 ...
 * @package BranchTargetMoukufApplication
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the BranchTargetMoukufApplication store with all CRUD functionality
export const branch_target_moukuf_application_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = branch_target_moukuf_application_store;

// Default export for Composition API usage
export default branch_target_moukuf_application_store;
