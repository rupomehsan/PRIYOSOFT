/**
 * Application Store - Factory Pattern Implementation
 *
...
// Create the Application store with all CRUD functionality
export const application_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = application_store;

// Default export for Composition API usage
export default application_store;
