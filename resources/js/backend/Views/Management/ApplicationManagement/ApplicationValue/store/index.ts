/**
 * ApplicationValue Store - Factory Pattern Implementation
 *
 ...
 * @package ApplicationValue
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ApplicationValue store with all CRUD functionality
export const application_value_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = application_value_store;

// Default export for Composition API usage
export default application_value_store;
