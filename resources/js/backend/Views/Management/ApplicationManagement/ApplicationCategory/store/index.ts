/**
 * ApplicationCategory Store - Factory Pattern Implementation
 *
...
// Create the ApplicationCategory store with all CRUD functionality
export const application_category_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = application_category_store;

// Default export for Composition API usage
export default application_category_store;
