/**
 * DivisionBudget Store - Factory Pattern Implementation
 *
 ...
 * @package DivisionBudget
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the DivisionBudget store with all CRUD functionality
export const division_budget_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = division_budget_store;

// Default export for Composition API usage
export default division_budget_store;
