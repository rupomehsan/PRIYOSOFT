/**
 * BranchTarget Store - Factory Pattern Implementation
 *
 ...
 * @package BranchTarget
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the BranchTarget store with all CRUD functionality
export const branch_target_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = branch_target_store;

// Default export for Composition API usage
export default branch_target_store;
