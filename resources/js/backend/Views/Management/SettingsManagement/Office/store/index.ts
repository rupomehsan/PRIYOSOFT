/**
 * Office Store - Factory Pattern Implementation
 *
...
// Create the Office store with all CRUD functionality
export const office_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = office_store;

// Default export for Composition API usage
export default office_store;
