/**
 * House Store - Factory Pattern Implementation
 *
...
// Create the House store with all CRUD functionality
export const house_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = house_store;

// Default export for Composition API usage
export default house_store;
