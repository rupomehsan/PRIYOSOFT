/**
 * TodoMilestone Store - Factory Pattern Implementation
 *
 ...
 * @package TodoMilestone
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the TodoMilestone store with all CRUD functionality
export const todo_milestone_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = todo_milestone_store;

// Default export for Composition API usage
export default todo_milestone_store;
