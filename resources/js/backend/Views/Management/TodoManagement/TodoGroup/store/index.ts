/**
 * TodoGroup Store - Factory Pattern Implementation
 *
...
// Create the TodoGroup store with all CRUD functionality
export const todo_group_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = todo_group_store;

// Default export for Composition API usage
export default todo_group_store;
