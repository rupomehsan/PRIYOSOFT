/**
 * VoucherAuditItem Store - Factory Pattern Implementation
 *
 ...
 * @package VoucherAuditItem
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the VoucherAuditItem store with all CRUD functionality
export const voucher_audit_item_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = voucher_audit_item_store;

// Default export for Composition API usage
export default voucher_audit_item_store;
