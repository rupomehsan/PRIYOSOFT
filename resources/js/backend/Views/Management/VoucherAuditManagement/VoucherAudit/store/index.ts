/**
 * VoucherAudit Store - Factory Pattern Implementation
 *
 ...
 * @package VoucherAudit
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the VoucherAudit store with all CRUD functionality
export const voucher_audit_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = voucher_audit_store;

// Default export for Composition API usage
export default voucher_audit_store;
