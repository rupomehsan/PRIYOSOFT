/**
 * Salary Store - Factory Pattern Implementation
 *
...
// Create the Salary store with all CRUD functionality
export const salary_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = salary_store;

// Default export for Composition API usage
export default salary_store;
