/**
 * SalarySheet Store - Factory Pattern Implementation
 *
...
// Create the SalarySheet store with all CRUD functionality
export const salary_sheet_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = salary_sheet_store;

// Default export for Composition API usage
export default salary_sheet_store;
