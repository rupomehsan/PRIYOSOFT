/**
 * Staff Store - Factory Pattern Implementation
 *
...
// Create the Staff store with all CRUD functionality
export const staff_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = staff_store;

// Default export for Composition API usage
export default staff_store;
