/**
 * WellWisher Store - Factory Pattern Implementation
 *
...
// Create the WellWisher store with all CRUD functionality
export const well_wisher_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = well_wisher_store;

// Default export for Composition API usage
export default well_wisher_store;
