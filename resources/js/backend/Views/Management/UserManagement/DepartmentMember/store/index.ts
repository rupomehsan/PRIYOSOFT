/**
 * DepartmentMember Store - Factory Pattern Implementation
 *
...
// Create the DepartmentMember store with all CRUD functionality
export const department_member_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = department_member_store;

// Default export for Composition API usage
export default department_member_store;
