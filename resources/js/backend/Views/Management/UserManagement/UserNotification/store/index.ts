/**
 * UserNotification Store - Factory Pattern Implementation
 *
...
// Create the UserNotification store with all CRUD functionality
export const user_notification_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = user_notification_store;

// Default export for Composition API usage
export default user_notification_store;
