/**
 * Sohid Store - Factory Pattern Implementation
 *
...
// Create the Sohid store with all CRUD functionality
export const sohid_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = sohid_store;

// Default export for Composition API usage
export default sohid_store;
