/**
 * Branch Store - Factory Pattern Implementation
 *
...
// Create the Branch store with all CRUD functionality
export const branch_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = branch_store;

// Default export for Composition API usage
export default branch_store;
