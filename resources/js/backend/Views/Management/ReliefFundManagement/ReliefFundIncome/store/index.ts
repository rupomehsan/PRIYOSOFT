/**
 * ReliefFundIncome Store - Factory Pattern Implementation
 *
 ...
 * @package ReliefFundIncome
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ReliefFundIncome store with all CRUD functionality
export const relief_fund_income_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = relief_fund_income_store;

// Default export for Composition API usage
export default relief_fund_income_store;
