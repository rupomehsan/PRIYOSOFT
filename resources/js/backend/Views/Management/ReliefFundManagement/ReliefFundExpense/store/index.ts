/**
 * ReliefFundExpense Store - Factory Pattern Implementation
 *
 ...
 * @package ReliefFundExpense
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the ReliefFundExpense store with all CRUD functionality
export const relief_fund_expense_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = relief_fund_expense_store;

// Default export for Composition API usage
export default relief_fund_expense_store;
