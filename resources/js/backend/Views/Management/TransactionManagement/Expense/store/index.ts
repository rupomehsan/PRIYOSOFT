/**
 * Expense Store - Factory Pattern Implementation
 *
...
// Create the Expense store with all CRUD functionality
export const expense_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = expense_store;
