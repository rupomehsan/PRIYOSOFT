/**
 * DepartmentTransfer Store - Factory Pattern Implementation
 *
 ...
 * @package DepartmentTransfer
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the DepartmentTransfer store with all CRUD functionality
export const department_transfer_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = department_transfer_store;

// Default export for Composition API usage
export default department_transfer_store;
