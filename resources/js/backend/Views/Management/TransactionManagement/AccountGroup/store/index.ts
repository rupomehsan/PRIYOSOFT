/**
 * AccountGroup Store - Factory Pattern Implementation
 *
...
// Create the AccountGroup store with all CRUD functionality
export const account_group_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = account_group_store;

// Default export for Composition API usage
export default account_group_store;
