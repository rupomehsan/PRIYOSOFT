/**
 * TransactionCategory Store - Factory Pattern Implementation
 *
...
// Create the TransactionCategory store with all CRUD functionality
export const transaction_category_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = transaction_category_store;

// Default export for Composition API usage
export default transaction_category_store;
