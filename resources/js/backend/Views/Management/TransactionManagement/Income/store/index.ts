/**
 * Income Store - Factory Pattern Implementation
 *
...
// Create the Income store with all CRUD functionality
export const income_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = income_store;
