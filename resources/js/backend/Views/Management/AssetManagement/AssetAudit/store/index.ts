/**
 * AssetAudit Store - Factory Pattern Implementation
 *
...
// Create the AssetAudit store with all CRUD functionality
export const asset_audit_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_audit_store;

// Default export for Composition API usage
export default asset_audit_store;
