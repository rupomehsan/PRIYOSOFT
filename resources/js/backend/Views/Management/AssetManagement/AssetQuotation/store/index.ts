/**
 * AssetQuotation Store - Factory Pattern Implementation
 *
 ...
 * @package AssetQuotation
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the AssetQuotation store with all CRUD functionality
export const asset_quotation_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_quotation_store;

// Default export for Composition API usage
export default asset_quotation_store;
