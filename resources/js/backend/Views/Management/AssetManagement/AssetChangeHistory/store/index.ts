/**
 * AssetChangeHistory Store - Factory Pattern Implementation
 *
 ...
 * @package AssetChangeHistory
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the AssetChangeHistory store with all CRUD functionality
export const asset_change_history_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_change_history_store;

// Default export for Composition API usage
export default asset_change_history_store;
