/**
 * AssetLost Store - Factory Pattern Implementation
 *
...
// Create the AssetLost store with all CRUD functionality
export const asset_lost_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_lost_store;

// Default export for Composition API usage
export default asset_lost_store;
