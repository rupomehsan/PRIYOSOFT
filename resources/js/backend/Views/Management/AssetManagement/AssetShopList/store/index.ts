/**
 * AssetShopList Store - Factory Pattern Implementation
 *
 ...
 * @package AssetShopList
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the AssetShopList store with all CRUD functionality
export const asset_shop_list_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_shop_list_store;

// Default export for Composition API usage
export default asset_shop_list_store;
