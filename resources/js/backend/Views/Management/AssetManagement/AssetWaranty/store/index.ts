/**
 * AssetWaranty Store - Factory Pattern Implementation
 *
 ...
 * @package AssetWaranty
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the AssetWaranty store with all CRUD functionality
export const asset_waranty_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_waranty_store;

// Default export for Composition API usage
export default asset_waranty_store;
