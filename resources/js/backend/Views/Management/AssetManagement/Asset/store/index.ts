/**
 * Asset Store - Factory Pattern Implementation
 *
...
// Create the Asset store with all CRUD functionality
export const asset_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_store;

// Default export for Composition API usage
export default asset_store;
