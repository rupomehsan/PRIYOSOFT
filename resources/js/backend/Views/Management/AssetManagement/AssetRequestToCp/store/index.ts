/**
 * AssetRequestToCp Store - Factory Pattern Implementation
 *
 ...
 * @package AssetRequestToCp
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the AssetRequestToCp store with all CRUD functionality
export const asset_request_to_cp_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_request_to_cp_store;

// Default export for Composition API usage
export default asset_request_to_cp_store;
