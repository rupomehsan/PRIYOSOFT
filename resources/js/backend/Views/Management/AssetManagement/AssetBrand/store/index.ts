/**
 * AssetBrand Store - Factory Pattern Implementation
 *
...
// Create the AssetBrand store with all CRUD functionality
export const asset_brand_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_brand_store;

// Default export for Composition API usage
export default asset_brand_store;
