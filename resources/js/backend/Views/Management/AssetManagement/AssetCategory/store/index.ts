/**
 * AssetCategory Store - Factory Pattern Implementation
 *
...
// Create the AssetCategory store with all CRUD functionality
export const asset_category_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = asset_category_store;

// Default export for Composition API usage
export default asset_category_store;
