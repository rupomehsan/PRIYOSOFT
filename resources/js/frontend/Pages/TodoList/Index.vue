        ...
        <div v-else class="tb-milestone-view">
          ...
          <div class="tb-mh" v-if="selectedMilestone">
            <div class="tb-mh__left">
              <span class="tb-mh__tag"
                ><i class="fas fa-flag-checkered"></i> Milestone</span
              >
              ...
              <div class="tb-mh__badges">
                ...
                <span
                  class="st-badge"
                  :class="'st-badge--' + (selectedMilestone.current_status || 'upcoming')"
                >
                  {{ selectedMilestone.current_status || "upcoming" }}
                </span>
                <span v-if="selectedMilestone.target_date" class="tb-mh__date">
                  <i class="fas fa-calendar-alt"></i> Target:
                  {{ formatDate(selectedMilestone.target_date) }}
                </span>
              </div>
              <p v-if="selectedMilestone.note" class="tb-mh__note">
            ...
            <div class="tb-mh__right">
              ...
              <div class="tb-mh__costs" v-if="milestoneBudget || milestoneGroupCost">
                ...
                <div
                  class="tb-mh-cost__divider"
                  v-if="milestoneBudget && milestoneGroupCost"
                ></div>
                <div class="tb-mh-cost tb-mh-cost--allocated" v-if="milestoneGroupCost">
                  <i class="fas fa-layer-group"></i>
                  <div>
                    <span class="tb-mh-cost__val">{{
                      formatCost(milestoneGroupCost)
                    }}</span>
          ...
          <!-- No groups -->
          <div
            v-if="!groupsForSelected.length"
            class="tb-state tb-state--center"
  ...
  computed: {
    ...
    milestoneTaskCount() {
      return this.groupsForSelected.reduce(
        (s, g) => s + this.tasksForGroup(g.id).length,
        0
      );
    },
    milestoneDoneCount() {
      return this.groupsForSelected.reduce(
        (s, g) =>
          s +
          this.tasksForGroup(g.id).filter((t) => t.current_status === "completed").length,
        0
      );
    },
    milestonePendingCount() {
      return this.groupsForSelected.reduce(
        (s, g) =>
          s +
          this.tasksForGroup(g.id).filter((t) => t.current_status === "pending").length,
        0
      );
    },
    ...
    milestoneGroupCost() {
      return this.selectedMilestoneId
        ? this.milestoneTotalCost(this.selectedMilestoneId)
        : 0;
    },
  },
...
.tb-mh-cost--budget .tb-mh-cost__val {
  color: #a5b4fc;
}
.tb-mh-cost--allocated .tb-mh-cost__val {
  color: #fbbf24;
}
.tb-mh-cost__lbl {
  display: block;
